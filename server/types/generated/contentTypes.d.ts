...
export interface ApiExperienceExperience extends Schema.CollectionType {
	...
	attributes: {
		Career: Attribute.Enumeration<['Education', 'Company']>;
...
export interface ApiGalleryGallery extends Schema.CollectionType {
	...
	attributes: {
		...
		category: Attribute.Enumeration<['Banner', 'Landing Page', 'Poster', 'Others']>;
...
export interface ApiProjectProject extends Schema.CollectionType {
	...
	attributes: {
		...
		role: Attribute.Enumeration<['Publisher', 'Designer', 'Frontend']>;
		add: Attribute.Enumeration<['Publisher', 'Designer', 'Frontend']>;
		more: Attribute.Enumeration<['Publisher', 'Designer', 'Frontend']>;
		contribution: Attribute.String;
...
export interface ApiSkillSkill extends Schema.CollectionType {
	...
	attributes: {
		name: Attribute.String;
		level: Attribute.Enumeration<['High', 'Middle', 'Low']>;
		icon: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
		description: Attribute.Text;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::skill.skill', 'oneToOne', 'admin::user'> & Attribute.Private;
		updatedBy: Attribute.Relation<'api::skill.skill', 'oneToOne', 'admin::user'> & Attribute.Private;
	};
}
